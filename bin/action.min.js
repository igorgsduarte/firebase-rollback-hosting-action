...
var BasicCredentialHandler_1 = BasicCredentialHandler;
...
var BearerCredentialHandler_1 = BearerCredentialHandler;
...
var PersonalAccessTokenCredentialHandler_1 = PersonalAccessTokenCredentialHandler;

var auth = /*#__PURE__*/Object.defineProperty({
	BasicCredentialHandler: BasicCredentialHandler_1,
	BearerCredentialHandler: BearerCredentialHandler_1,
	PersonalAccessTokenCredentialHandler: PersonalAccessTokenCredentialHandler_1
}, '__esModule', {value: true});
...
const SCOPES = ["https://www.googleapis.com/auth/cloud-platform", "https://www.googleapis.com/auth/cloud-platform.read-only", "https://www.googleapis.com/auth/firebase", "https://www.googleapis.com/auth/firebase.readonly"];

const generateAccessToken = gacJson => new Promise((resolve, reject) => {
  const jwtClient = new googleapis.google.auth.JWT(gacJson.client_email, null, gacJson.private_key, SCOPES, null);
...
const getReleases = async ({
  ...
  try {
    ...
    const {
      data
    } = await axios__default["default"](`https://firebasehosting.googleapis.com/v1beta1/sites/${projectId}/channels/${channelId}/releases`, {
      headers: {
        Authorization: "Bearer " + token
      }
    });
    return (data == null ? void 0 : (_data$releases = data.releases) == null ? void 0 : _data$releases.map(release => {
    ...
    core.setFailed((error == null ? void 0 : (_error$response = error.response) == null ? void 0 : _error$response.data) || error.message);
  }
};
async function setRelease({
  ...
  try {
    ...
    var _error$response2, _error$response2$data, _error$response2$data2, _error$response3, _error$response3$data, _error$response3$data2, _error$response4, _error$response4$data;

    if ((error == null ? void 0 : (_error$response2 = error.response) == null ? void 0 : (_error$response2$data = _error$response2.data) == null ? void 0 : (_error$response2$data2 = _error$response2$data.error) == null ? void 0 : _error$response2$data2.code) === 400 && (error == null ? void 0 : (_error$response3 = error.response) == null ? void 0 : (_error$response3$data = _error$response3.data) == null ? void 0 : (_error$response3$data2 = _error$response3$data.error) == null ? void 0 : _error$response3$data2.message.indexOf("is the current active version.")) >= 0) {
      return {
        message: `${versionName} is the current active version.`
      };
    }

    console.error((error == null ? void 0 : (_error$response4 = error.response) == null ? void 0 : (_error$response4$data = _error$response4.data) == null ? void 0 : _error$response4$data.error) || error.message);
  }
}
...
const channelId = core.getInput("channelId") || "live";
...
async function run() {
  ...
  try {
    ...
    if (require$$0$1.existsSync("./firebase.json")) {
    ...
    if (!versionName) {
      ...
      core.startGroup("Get last hosting releases");
      ...
      core.setOutput("releases", versions);
      core.setOutput("current_version", ((_versions$ = versions[0]) == null ? void 0 : _versions$.version.name) || null);
      core.endGroup();
      finish({
        conclusion: "success",
        output: {
    ...
    core.startGroup("Start a version rollback ...");
    setRelease({
      gacJson: JSON.parse(googleApplicationCredentials),
      projectId,
      channelId,
